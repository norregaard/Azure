...
param virtualNetworkName string = 'vnet-XXX-weu-003'
...
@description('Size of the virtual machine.')
param serverSize string = 'Standard_B2s'

var vnetAddressPrefix = '10.102.0.0/18'
var serversSubnetPrefix = '10.102.2.0/24'
var azureFirewallSubnetPrefix = '10.102.1.0/24'
var jumpboxSubnetPrefix = '10.102.0.0/24'
var nextHopIP = '10.102.1.4'
...
var firewallName = 'fw-conn-weu-001'
